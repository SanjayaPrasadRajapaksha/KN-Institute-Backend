...
const sendOTP = async (email, name, otp) => {
  try {
    ...
    <div style="font-family: Arial, sans-serif; background:#f4f7fc; padding:40px;">
      <div style="max-width:600px; margin:auto; background:#fff; border-radius:15px; overflow:hidden; box-shadow:0 5px 20px rgba(0,0,0,0.1);">
        ...
        <div style="padding:35px;">
          ...
          <div style="background:#f8fafc; border-left:5px solid #2563eb; padding:20px; margin:25px 0; border-radius:8px; text-align:center;">
            <p style="margin:0; color:#444; font-size:24px; font-weight:bold;">
              ${otp} <!-- Assuming you have an OTP variable -->
            </p>
          </div>
    ...
    const mailOptions = {
      ...
      html: credentialMessage, // Use html instead of text
    };
